...
bool Wkl::doTest(std::string profilname)
{
	...
	{
		schreibeLog(WkLog::WkLog_NORMALTYPE, fehlerSDir, 
			WkLog::WkLog_ROT, WkLog::WkLog_FETT);
		fehler = true;
	}
	...
	{
		schreibeLog(WkLog::WkLog_NORMALTYPE, fehlerODir, 
			WkLog::WkLog_ROT, WkLog::WkLog_FETT);
		fehler = true;
	}
	...
	{
		schreibeLog(WkLog::WkLog_NORMALTYPE, fehlerODat, 
			WkLog::WkLog_ROT, WkLog::WkLog_FETT);
		fehler = true;
	}
	...
	{
		schreibeLog(WkLog::WkLog_NORMALTYPE, fehlerIDat, 
			WkLog::WkLog_ROT, WkLog::WkLog_FETT);
		fehler = true;
	}
...
void Wkl::schreibeLog(int type, std::string logEintrag, int farbe, int format, int groesse)
{
#ifdef _WINDOWS_
	//Sleep(20);
#else
