...
WkmParser::WkmParser(std::string suchPfad, WkmDB *db, WkLog *logA)
{
	suchVz = suchPfad;
	dieDB = db;
	logAusgabe = logA;
...
void WkmParser::ipNetzeEintragen(std::string intfip, std::string intfmask)
{
	boost::system::error_code errorcode = boost::asio::error::host_not_found;
