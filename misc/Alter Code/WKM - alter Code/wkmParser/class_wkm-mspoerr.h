...
private:
	...
	int vari[18];						// Array für die Int Variablen

	std::string attString[9];
	std::string attInt[18];
	...
	static const int wkmDbVersion = 2;	// DB Version -> Immer wenn neue Elemente in DB hinzugefügt werden, wird die DB Version um 1 erhöht
	...
	WkmCombiner *derCombiner;			// Zeiger auf den Combiner
