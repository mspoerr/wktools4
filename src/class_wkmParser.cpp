...
void WkmParser::varsInit()
{
	...
	pos21 = pos22 = pos23 = pos24 = pos25 = pos26 = pos27 = pos28 = pos29 = pos30 = pos31 = pos32 = pos33 = pos34 = pos35 = pos36 = pos37 = pos38 = pos39 = 0;
	pos40 = pos41 = pos42 = pos43 = pos44 = pos45 = pos46 = pos47 = pos48 = pos49 = 0;
	aktPos1 = aktPos2 = 0;
...
int WkmParser::startParser(std::string pattern)
{
		...
		if (vorhanden)
		{
			...
			else if (ganzeDatei.find("!!! UseScript ") < ganzeDatei.find_first_of("\r\n"))
			{
				...
				if ((iErr = luaL_loadfile(lua, luaScriptName.c_str())) == 0)
				{
					...
					// ParserDB Funktionen für Lua verfügbar machen
					luabind::module(lua) [
						luabind::class_<WkmParserDB>("WkmParserDB")
	//						.def(luabind::constructor<>())
							.def("markNeighbor", &WkmParserDB::markNeighbor)
							.def("unknownNetworkSchreiber", &WkmParserDB::unknownNetworkSchreiber)
							.def("insertDevice", &WkmParserDB::insertDevice)
							.def("insertSubnet", &WkmParserDB::ipNetzeEintragen)
							.def("nextHopIntfCheck", &WkmParserDB::nextHopIntfCheck)
							.def("maskToBits", &WkmParserDB::maskToBits)
							.def("intfNameChange", &WkmParserDB::intfNameChange)
							.def("intfTypeCheck", &WkmParserDB::intfTypeCheck)
							.def("intfPhlCheck", &WkmParserDB::intfPhlCheck)
							.def("macAddChange", &WkmParserDB::macAddChange)
							.def("insertHardware", &WkmParserDB::insertHardware)
							.def("updateHardware", &WkmParserDB::updateHardware)
							.def("insertLic", &WkmParserDB::insertLic)
							.def("insertSTPStatus", &WkmParserDB::insertSTPStatus)
							.def("insertVlan", &WkmParserDB::insertVlan)
							.def("insertSTPInstance", &WkmParserDB::insertSTPInstance)
							.def("insertNeighbor", &WkmParserDB::insertNeighbor)
							.def("getIntfID", &WkmParserDB::getIntfID)
							.def("insertVrf", &WkmParserDB::insertVrf)
							.def("insertVrfLink", &WkmParserDB::insertVrfLink)
							.def("insertFlash", &WkmParserDB::insertFlash)
							.def("insertRoute", &WkmParserDB::insertRoute)
							.def("insertCDP", &WkmParserDB::insertCDP)
							.def("getIntfNameFromNameif", &WkmParserDB::getIntfNameFromNameif)
							.def("getIntfIDFromNameif", &WkmParserDB::getIntfIDFromNameif)
							.def("insertPhone", &WkmParserDB::insertPhone)
							.def("updateSTP", &WkmParserDB::updateSTP)
							.def("updateDeviceDataSource", &WkmParserDB::updateDeviceDataSource)
							.def("updateChannelMember", &WkmParserDB::updateChannelMember)
							.def("updateSubInterfaces", &WkmParserDB::updateSubInterfaces)
							.def("markVSL", &WkmParserDB::markVSL)
							.def("markVPC", &WkmParserDB::markVPC)
							.def("markVethMember", &WkmParserDB::markVethMember)
							.def("updateIntfL2Info", &WkmParserDB::updateIntfL2Info)
							.def("insertSnmp", &WkmParserDB::insertSnmp)
							.def("insertCryptoMapIntf", &WkmParserDB::insertCryptoMapIntf)
							.def("insertPoeDev", &WkmParserDB::insertPoeDev)
							.def("insertPoeIntf", &WkmParserDB::insertPoeIntf)
							.def("insertInterface", &WkmParserDB::insertInterfaceStruct)
							.def("insertIntfStats", &WkmParserDB::insertIntfStatsStruct)
							.def("insertIntfN1k", &WkmParserDB::insertIntfN1k)
							.def("printString", &WkmParserDB::schreibeLogMin)
							.def("getStringToParse", &WkmParserDB::getSTP)
							.def("insertCryptoIntf", &WkmParserDB::insertCryptoIntf)
							.def("insertCrypto", &WkmParserDB::insertCrypto)
							.def("getIntfNameFromID", &WkmParserDB::getIntfNameFromID)
							.def("insertRpGlobal", &WkmParserDB::insertRpGlobal)
							.def("insertRpNeighbor", &WkmParserDB::insertRpNeighbor)
							.def("insertOspfProcess", &WkmParserDB::insertOspfProcess)
							.def("insertOspfIntf", &WkmParserDB::insertOspfIntf)
							.def("getIntfIDfromL3Route", &WkmParserDB::getIntfIDfromL3Route)
							.def("getIntfNamefromIP", &WkmParserDB::getIntfNamefromIP)
							.def("insertHSRP", &WkmParserDB::insertHSRP)
							.def("insertDot1xUser", &WkmParserDB::insertDot1xUser)
							.def("insertDot1xIntf", &WkmParserDB::insertDot1xIntf)
							.def("insertDot1xDev", &WkmParserDB::insertDot1xDev)

							.def("insertDevTracking", &WkmParserDB::insertDevTracking)
							.def("insertDHCPSnooping", &WkmParserDB::insertDHCPSnooping)
							.def("insertSnoopingIntf", &WkmParserDB::insertSnoopingIntf)
							.def("insertSnoopingDev", &WkmParserDB::insertSnoopingDev)
							.def("insertDevTrackingDev", &WkmParserDB::insertDevTrackingDev)

							.def("insertFOStatus", &WkmParserDB::insertFOStatus),
							luabind::class_<WkmParserDB::cryptoSets>("cryptoSets")
							.def(luabind::constructor<>())
							.def_readwrite("intfName", &WkmParserDB::cryptoSets::intfName)
							.def_readwrite("dev_id", &WkmParserDB::cryptoSets::dev_id)
							.def_readwrite("peer", &WkmParserDB::cryptoSets::peer)
							.def_readwrite("local_net", &WkmParserDB::cryptoSets::local_net)
							.def_readwrite("remote_net", &WkmParserDB::cryptoSets::remote_net)
							.def_readwrite("vrf", &WkmParserDB::cryptoSets::vrf)
							.def_readwrite("pfs_grp", &WkmParserDB::cryptoSets::pfs_grp)
							.def_readwrite("pkt_encaps", &WkmParserDB::cryptoSets::pkt_encaps)
							.def_readwrite("pkt_decaps", &WkmParserDB::cryptoSets::pkt_decaps)
							.def_readwrite("pkt_encrypt", &WkmParserDB::cryptoSets::pkt_encrypt)
							.def_readwrite("pkt_decrypt", &WkmParserDB::cryptoSets::pkt_decrypt)
							.def_readwrite("send_err", &WkmParserDB::cryptoSets::send_err)
							.def_readwrite("rcv_err", &WkmParserDB::cryptoSets::rcv_err)
							.def_readwrite("path_mtu", &WkmParserDB::cryptoSets::path_mtu)
							.def_readwrite("status", &WkmParserDB::cryptoSets::status)
							.def_readwrite("esp_i", &WkmParserDB::cryptoSets::esp_i)
							.def_readwrite("ah_i", &WkmParserDB::cryptoSets::ah_i)
							.def_readwrite("pcp_i", &WkmParserDB::cryptoSets::pcp_i)
							.def_readwrite("esp_o", &WkmParserDB::cryptoSets::esp_o)
							.def_readwrite("ah_o", &WkmParserDB::cryptoSets::ah_o)
							.def_readwrite("pcp_o", &WkmParserDB::cryptoSets::pcp_o)
							.def_readwrite("settings", &WkmParserDB::cryptoSets::settings)
							.def_readwrite("tag", &WkmParserDB::cryptoSets::tag)
							.def_readwrite("seqnr", &WkmParserDB::cryptoSets::seqnr),
						luabind::class_<WkmParserDB::intfSets>("intfSets")
							.def(luabind::constructor<>())
							.def_readwrite("intfName", &WkmParserDB::intfSets::intfName)
							.def_readwrite("nameif", &WkmParserDB::intfSets::nameif)
							.def_readwrite("intfType", &WkmParserDB::intfSets::intfType)
							.def_readwrite("phl", &WkmParserDB::intfSets::phl)		
							.def_readwrite("macAddress", &WkmParserDB::intfSets::macAddress)
							.def_readwrite("ipAddress", &WkmParserDB::intfSets::ipAddress)
							.def_readwrite("subnetMask", &WkmParserDB::intfSets::subnetMask)
							.def_readwrite("duplex", &WkmParserDB::intfSets::duplex)
							.def_readwrite("speed", &WkmParserDB::intfSets::speed)
							.def_readwrite("status", &WkmParserDB::intfSets::status)
							.def_readwrite("description", &WkmParserDB::intfSets::description)
							.def_readwrite("l2l3", &WkmParserDB::intfSets::l2l3)
							.def_readwrite("dev_id", &WkmParserDB::intfSets::dev_id),
						luabind::class_<WkmParserDB::intfStats>("intfStats")
							.def(luabind::constructor<>())
							.def_readwrite("errLvl", &WkmParserDB::intfStats::errLvl)
							.def_readwrite("lastClear", &WkmParserDB::intfStats::lastClear)
							.def_readwrite("loadLvl", &WkmParserDB::intfStats::loadLvl)
							.def_readwrite("iCrc", &WkmParserDB::intfStats::iCrc)
							.def_readwrite("iFrame", &WkmParserDB::intfStats::iFrame)
							.def_readwrite("iOverrun", &WkmParserDB::intfStats::iOverrun)
							.def_readwrite("iIgnored", &WkmParserDB::intfStats::iIgnored)
							.def_readwrite("iWatchdog", &WkmParserDB::intfStats::iWatchdog)
							.def_readwrite("iPause", &WkmParserDB::intfStats::iPause)
							.def_readwrite("iDribbleCondition", &WkmParserDB::intfStats::iDribbleCondition)
							.def_readwrite("ibuffer", &WkmParserDB::intfStats::ibuffer)
							.def_readwrite("l2decodeDrops", &WkmParserDB::intfStats::l2decodeDrops)
							.def_readwrite("runts", &WkmParserDB::intfStats::runts)
							.def_readwrite("giants", &WkmParserDB::intfStats::giants)
							.def_readwrite("throttles", &WkmParserDB::intfStats::throttles)
							.def_readwrite("ierrors", &WkmParserDB::intfStats::ierrors)
							.def_readwrite("underrun", &WkmParserDB::intfStats::underrun)
							.def_readwrite("oerrors", &WkmParserDB::intfStats::oerrors)
							.def_readwrite("oCollisions", &WkmParserDB::intfStats::oCollisions)
							.def_readwrite("oBabbles", &WkmParserDB::intfStats::oBabbles)
							.def_readwrite("oLateColl", &WkmParserDB::intfStats::oLateColl)
							.def_readwrite("oDeferred", &WkmParserDB::intfStats::oDeferred)
							.def_readwrite("oLostCarrier", &WkmParserDB::intfStats::oLostCarrier)
							.def_readwrite("oNoCarrier", &WkmParserDB::intfStats::oNoCarrier)
							.def_readwrite("oPauseOutput", &WkmParserDB::intfStats::oPauseOutput)
							.def_readwrite("oBufferSwapped", &WkmParserDB::intfStats::oBufferSwapped)
							.def_readwrite("resets", &WkmParserDB::intfStats::resets)
							.def_readwrite("obuffer", &WkmParserDB::intfStats::obuffer)
							.def_readwrite("lastInput", &WkmParserDB::intfStats::lastInput)
							.def_readwrite("intf_id", &WkmParserDB::intfStats::intf_id)					
					];

					luabind::globals(lua)["ParserDB"] = parserdb;

					luaopen_io(lua);			        // Load io library
					luaL_openlibs(lua);

					// ganzeDatei an ParserDB übergeben
					parserdb->setSTP(ganzeDatei);

					// Execute Script
					luaL_dofile(lua, luaScriptName.c_str());
				}
				else
				{
			...
			else
			{
				...
				pos33 = ganzeDatei.find("show failover", pos32);
				pos34 = ganzeDatei.find("show fex", pos33);
				pos35 = ganzeDatei.find("show ip ospf", pos34);
				pos36 = ganzeDatei.find("show ip ospf interface", pos35);
				pos37 = ganzeDatei.find("show ospf", pos36);
				pos38 = ganzeDatei.find("show ospf interface", pos37);
				pos39 = ganzeDatei.find("show ip bgp neighbors", pos38);
				pos40 = ganzeDatei.find("show standby brief", pos39); 
				pos41 = ganzeDatei.find("show hsrp brief", pos40); 
				pos42 = ganzeDatei.find("show dot1x all", pos41);
				pos43 = ganzeDatei.find("show mab all", pos42);
				pos44 = ganzeDatei.find("show authentication session", pos43);
				pos45 = ganzeDatei.find("show vlan", pos44);
				pos46 = ganzeDatei.find("show spanning-tree mst", pos45);
				pos47 = ganzeDatei.find("show ip dhcp snooping", pos46);
				pos48 = ganzeDatei.find("show ip dhcp snooping binding", pos47);
				pos49 = ganzeDatei.find("show ip device tracking all", pos48);

				pos99 = ganzeDatei.find("show ip route vrf ", pos49);
	...
	parserdb->unknownNextHopsSchreiber();
	parserdb->unknownrpNeighborSchreiber();
	parserdb->unknownIpsecPeersSchreiber();
	//if (importHosts)
	//{
	//	hostSchreiber();
	//}
...
void WkmParser::testIOS()
{
	...
	if (aktPos1 < pos1)
	{
		...
		else	
		{
			...
			if (aktPos2 != ganzeDatei.npos)
			{
				...
				else if (modell.find("IOS-XE") != modell.npos)
				{
					// Cat4k IOS XE Switch
					if ((aktPos1 = ganzeDatei.find("isco WS", aktPos1)) != ganzeDatei.npos)
					{
						aktPos1 += 5;
	...
	iosPoeParser();
	iosVrfParser();
	iosVrfRouteArpParser();
	iosHSRPParser(pos40, pos41);
	iosDot1xParser();
	iosMabParser();
	iosAuthParser();
	iosVlanParser();
	iosMSTParser();
	iosDhcpSnoopParser();
	iosDhcpSnoopBindParser();
	iosDevTrackingParser();
...
void WkmParser::iosInterfaceParser()
{
	...
	while (intfpos < pos2)
	{
		...
		// Check ob unnumbered
		else if ((aktPos1 = ganzeDatei.find("Interface is unnumbered. Using address of ", aktPos2)) < intfpos)
		{
			aktPos1 += 42;
			aktPos2 = ganzeDatei.find(" ", aktPos1) + 1;
			std::string unnumberIntf = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1 - 1);

			intfIP = "unnumbered " + unnumberIntf;
		...
		else if ((aktPos1 = ganzeDatei.find("Member ", aktPos2)) < intfpos)
		{
			// IOS Router
			do
			{
			...
			while ((aktPos1 = ganzeDatei.find("Member ", aktPos2)) < intfpos);
		}

		// Duplex und Speed falls vorhanden
		std::string duplex = "";
		std::string speed = "";
		std::string tunnelSource = "";
		std::string tunnelDest = "";
		...
		else if ((aktPos1 = ganzeDatei.find("Tunnel source ", aktPos2)) < intfpos)
		{
			// Tunnel Source und Destination falls vorhanden
			aktPos1 += 14;
			aktPos2 = ganzeDatei.find_first_of(", ", aktPos1);
			tunnelSource = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

			aktPos1 = ganzeDatei.find("destination ", aktPos2) + 12;
			aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
			tunnelDest = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		}
		...
		if (intfHauptIntf != "")
		{
			std::string mintf_id = parserdb->getIntfID(dev_id, intfHauptIntf, true);
			parserdb->updateSubInterfaces(intf_id, mintf_id, dev_id);
		}

		// Tunnel Infos eintragen
		if (tunnelSource != "")
		{
			parserdb->insertCryptoIntf("", tunnelSource, tunnelDest, intfName, dev_id);
		}

		// ipSubnet befüllen
		if (intfIP != "" && intfIP.find("unnumbered") ==intfIP.npos)
		{
...
void WkmParser::iosSTPParser()
{
	...
	else if (ganzeDatei.find("of MST", stpStartpos) < pos5)
	{
		stpneu = 1;
	}
	...
	while (stppos < ganzeDatei.npos)
	{
		...
		{
			// VLAN Tabelle befüllen
			vlID = parserdb->insertVlan(vlanID, dev_id, stpInstanzID);
		}
		else
		{
			// MST Workaround; 9xxx VLANS sind immer 9 + MST Instanz Nummer mit führenden 0, damit vierstellig
			if (vlanID.length() == 1)
			{
				vlanID = "900" + vlanID;
			}
			else if (vlanID.length() == 2)
			{
				vlanID = "90" + vlanID;
			}
			else if (vlanID.length() == 3)
			{
				vlanID = "9" + vlanID;
			}
			// VLAN Tabelle befüllen
		...
		{
			std::string statsOnly = "0";		// Nur für Statistik?
			aktPos1 = portPos;
			...
			if (bpduCntPos < portPos)
			{
				...
				parserdb->insertSTPStatus(dev_id, intfName, stpStatus, stpRootIDPort, stpDesignatedBridgeID, stpTransitionNumber, vlID, iVl, statsOnly);
			}
		}
	}
...
void WkmParser::iosARPParser(std::size_t startpos, std::size_t endePos)
{
	zeitStempel("\tiosARPParser START");

	if (endePos == ganzeDatei.npos)
	{
		endePos = ganzeDatei.size();
	}

	if (endePos-startpos > 300)
	{
		aktPos1 = ganzeDatei.find("Interface", startpos);
...
void WkmParser::iosCAMParser()
{
	...
	if (campos2-campos1 > 250)
	{
		...
		size_t typePos1 = ganzeDatei.find("Codes: * - primary entry", campos1);
		...
		size_t typeASR = ganzeDatei.find("Nile Mac Address Entries", campos1);
		if (typePos < ganzeDatei.npos || typePos1 < ganzeDatei.npos)
		{
			// Cat6k
			bool neueVer = false;
			if (ganzeDatei.find("----+----+---------------+-------+-----+----------+-----", typePos) != ganzeDatei.npos)
			{
				neueVer = true;
			}
			...
			else if (typePos1 < ganzeDatei.npos)
			{
				// Cat6k alt
				offsets[4] = 22;
				offsets[5] = 22;
			...
			for (; aktPos2 < camString.npos;)
			{
				...
				if (camZeile.size() > 50)
				{
					...
					for(boost::tokenizer<boost::offset_separator>::iterator beg=tok.begin(); beg!=tok.end();++beg)
					{
						...
						case 1:
							vlan = *beg;
							boost::algorithm::trim(vlan);
							break;
						case 3:
							maca = *beg;
							maca = parserdb->macAddChange(maca);
							boost::algorithm::trim(maca);
							break;
						case 5:
							intf = *beg;
					...
					if ((intf.find(",") == intf.npos) && (intf.find("Router") == intf.npos))
					{
						// Zuerst die Interface ID in der interface Tabelle suchen
						std::string intfID = "";
						if (iname != intf)
		...
		else if (typePos4k < ganzeDatei.npos)			// Catalyst 4k
		{
			// Cat4k
		...
		else if (typeXLPos < ganzeDatei.npos)		// Catalyst 3k und 2k XL
		{
			aktPos1 = ganzeDatei.find("------", campos1);
			aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1) + 1;
			aktPos2 = ganzeDatei.find("#", aktPos1);
		...
		else if (typeASR < ganzeDatei.npos)			// ASR 920
		{
			// ASR 920
			aktPos1 = ganzeDatei.find("----------------------------------", campos1);
			aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1) + 1;
			std::string camString = ganzeDatei.substr(aktPos1, campos2 - aktPos1);
			...
			for (; aktPos2 < camString.npos;)
			{
				...
				camZeile = camString.substr(aktPos1 + 1, aktPos2 - aktPos1 - 1);
				aktPos1 = aktPos2;
				if ((camZeile.size() > 35) && (camZeile.find("Nile Mac Address Entries") == camZeile.npos) && (camZeile.find("------------------------------") == camZeile.npos) && (camZeile.find("BD    mac addr        type     ports") == camZeile.npos))
				{
					int i = 0;
					boost::char_separator<char> sep(" \t");
					boost::tokenizer<boost::char_separator<char>> tok(camZeile, sep);
					...
					if (intf.find("CPU") == intf.npos)
					{
						...
						// .Efp und .tepf weglöschen
						intf = intf.substr(0, intf.find(".Efp"));
						intf = intf.substr(0, intf.find(".tefp"));
		...
		else
		{
			...
			for (; aktPos2 < camString.npos;)
			{
				...
				if (camZeile.size() > 35)
				{
					...
					if ((intf.find("CPU") == intf.npos) && (intf.find("Drop") == intf.npos))
					{
						// Zuerst die Interface ID in der interface Tabelle suchen
						std::string intfID = "";
						if (iname != intf)
...
void WkmParser::catosCDPParser()
{
	zeitStempel("\tcatosCDPParser START");

	size_t cdppos = ganzeDatei.find("Physical Location:", pos5);
	cdppos = ganzeDatei.find_first_of("\r\n", cdppos);

	while (cdppos < pos6)
	{
		// Der nächste Nachbar
		aktPos1 = cdppos;
		cdppos = ganzeDatei.find("Physical Location:", cdppos + 10);
		cdppos = ganzeDatei.find_first_of("\r\n", cdppos);
		...
		std::string nIntf = "";
		if ((aktPos1 = ganzeDatei.find("Port (Our Port): ", aktPos1)) < cdppos)
		{
			aktPos1 += 17;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
		...
		if ((aktPos1 = ganzeDatei.find("Device-ID: ", aktPos1)) < cdppos)
		{
			...
			{
				size_t npos1 = nName.find("(") + 1;
				size_t npos2 = nName.find(")");
				nName = nName.substr(npos1, npos2-npos1);
				alternatenName = nName;
			}
		}
		...
		if ((aktPos1 = ganzeDatei.find("Capabilities: ", tempPos)) < cdppos)
		{
			...
			else if (nT.find("TRANSPARENT_BRIDGE") != nT.npos)
			{
				nType = "2";
			}
		}
		...
		std::string nNintf = "";
		if ((aktPos1 = ganzeDatei.find("Port-ID (Port on Neighbors's Device): ", aktPos1)) < cdppos)
		{
			aktPos1 += 38;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
		...
		{
			// DB befüllen:
			// Interface unbekannt -> Interface bei der Box hinzufügen, damit alle CDP Nachbarschaften ok sind.
			parserdb->insertInterface(nIntf, "", "", "1", "", "", "", "", "", "UP", "CDP Only Interface", "L2", dev_id);
			
			// CDP Nachbaren noch einmal eintragen
...
void WkmParser::iosCDPParser()
{
	...
	while (cdppos < pos6)
	{
		...
		if ((aktPos1 = ganzeDatei.find("Version :", aktPos1)) < cdppos)
		{
			...
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			nSWver = parserdb->intfNameChange(ganzeDatei.substr(aktPos1, aktPos2-aktPos1));
			if (nSWver.find("McpSW") != nSWver.npos)
			{
				std::size_t zwischenPos1 = nSWver.find("McpSW")+7;
				std::size_t zwischenPos2 = nSWver.find_first_of("\r\n ,", zwischenPos1);
				nSWver = nSWver.substr(zwischenPos1, zwischenPos2-zwischenPos1);

				// CatOS; Daher muss auch im Fall der hostname geändert werden
				if (alternatenName.find("(") != nName.npos)
				{
					size_t npos1 = alternatenName.find("(") + 1;
					size_t npos2 = alternatenName.find(")");
					nName = alternatenName.substr(npos1, npos2-npos1);
					alternatenName = nName;
				}
			}
			else if (nSWver.find("Version") != nSWver.npos)
			{
				std::size_t zwischenPos1 = nSWver.find("Version")+8;
				std::size_t zwischenPos2 = nSWver.find_first_of("\r\n ,", zwischenPos1);
				nSWver = nSWver.substr(zwischenPos1, zwischenPos2-zwischenPos1);
		...
		// DB befüllen:
		bool cdpStat = parserdb->insertCDP(hostname, nName, alternatenName, nIntf, ipa, nNintf, nType, platform, nSWver, dev_id);
		if (!cdpStat)
		{
			// Interface unbekannt -> Interface bei der Box hinzufügen, damit alle CDP Nachbarschaften ok sind.
			parserdb->insertInterface(nIntf, "", "", "1", "", "", "", "", "", "UP", "CDP Only Interface", "L2", dev_id);
...
void WkmParser::testNexus()
{
	...
	devType = "2";
	std::string hwType = "2";
	// devType für UCS und N1k anpassen
	if (modell.find("Fabric Interconnect") != modell.npos)
	{
		devType = "20";
	}
	else if (modell.find("Nexus 1000V") != modell.npos)
	{
		devType = "21";
	}
	dev_id = parserdb->insertDevice(hostname, devType, hwType, confReg);
	if (dev_id != "")
	{
		hwInfo_id = parserdb->insertHardware(hwPos, modell, hwDescription, chassisSN, hwRevision, hwMem, hwBootfile, version, dev_id, "");
		nxosInterfaceParser();
...
void WkmParser::nxosInterfaceParser()
{
	...
	{
		bool intfup = true;	// Interface up (true) oder down (true)? -> Es werden doch alle Interfaces, egal mit welchem Status, verarbeitet
		// intfpos bestimmen
		...
		if (intfup)
		{
			...
			// Check ob IP Adresse in der Description verpackt, da Desription und IP in einer Wurst in einer Zeile
			std::size_t ipInDescrPos = 0;
			if ((ipInDescrPos = intfDescription.find("Internet Address is ")) != intfDescription.npos)
			{
				std::size_t maskPos = intfDescription.find("/", ipInDescrPos + 20);
				intfIP = intfDescription.substr(ipInDescrPos + 20, maskPos - ipInDescrPos - 20);
				intfIPMask = intfDescription.substr(maskPos+1, intfDescription.size() - maskPos-1);
				
				l2l3 = "L3";
				
				intfDescription = intfDescription.substr(0, ipInDescrPos);
			}
			...
			parserdb->insertIntfStats(boost::lexical_cast<std::string>(err), lastClear, boost::lexical_cast<std::string>(intfLoadLevel), iCrc, iFrame, iOverrun, iIgnored, iWatchdog, iPause, iDribbleCondition, 
				...
				obuffer, lastChange, intf_id);
			parserdb->insertIntfN1k(actModule, ownerIs, portProfile, intf_id);
...
void WkmParser::nxosVPCParser()
{
	...
	aktPos1 = ganzeDatei.find("Active vlans", pos8);
	aktPos1 = ganzeDatei.find("-----------------------------------", aktPos1);
	aktPos1 = ganzeDatei.find(" ", aktPos1);
	if (aktPos1 != ganzeDatei.npos)
	{
		std::size_t tpos = aktPos1;
		aktPos1 = ganzeDatei.find("vPC domain id", pos8);
		if (aktPos1 < pos9)
		{
			std::string vpcDomId = "";
		...
		if (aktPos1 < pos9)
		{
			std::string vpcString = ganzeDatei.substr(aktPos1-1, pos9-aktPos1);
			std::string vpcZeile = "";

			std::string id = "";
			std::string port = "";
			std::string status = "";
			std::string consistCheck = "";	// Fehlerhafte Zeilen haben weniger als 4 Spalten; Wenn dieser Wert am Ende leer ist, dann ist die Zeile fehlerhaft
			...
			for (; aktPos2 < vpcString.npos;)
			{
				...
				if (vpcZeile.size() > 50 && vpcZeile[0] != ' ')
				{
					...
					if ((status.find("down") == status.npos) && (consistCheck != "") && (id[0] != '-'))
					{
						// Die vPCs markeren
...
void WkmParser::pixOSOSPFParser()
{
	...
	// show ospf pos37-pos38
	/////////////////////////////////////////////////////
	if (pos38 - pos37 > 300)
	{
		size_t procpos = ganzeDatei.find("Routing Process \"", pos37);
		if (procpos < pos38)
		{
			procpos += 17;
			...
			while (procpos < pos38)
			{
				// OSPF Process ID
				aktPos1 = procpos;
				procpos = ganzeDatei.find("Routing Process \"", procpos + 70);
				if (procpos > pos38)
				{
					procpos = pos38 + 2;
				}
				...
				std::string vrf = "";
				std::string spfLast = "";
				std::string spfExecNumber = "";

				aktPos1 = ganzeDatei.find(" ", aktPos1) + 1;
				aktPos2 = ganzeDatei.find("\"", aktPos1);
				processID = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

				if ((aktPos1 = ganzeDatei.find("with ID ", aktPos2)) < pos38)
				{
					aktPos1 += 8;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					routerID = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
				}
				if ((aktPos1 = ganzeDatei.find("SPF algorithm last executed ", aktPos2)) < pos38)
				{
					aktPos1 += 28;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					spfLast = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
				}
				if ((aktPos1 = ganzeDatei.find("SPF algorithm executed ", aktPos2)) < pos38)
				{
					aktPos1 += 23;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					spfExecNumber = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
				}

				parserdb->insertOspfProcess(routerID, processID, vrf, spfExecNumber, spfLast, dev_id);
			}
		}
	}

	// show ip ospf interface pos38-pos99
	//////////////////////////////////
	size_t intfpos = ganzeDatei.find(", line protocol is", pos38);
	if (intfpos != ganzeDatei.npos)
	{
		...
		while (intfpos < pos39)
		{
			...
			else if (intfpos == ganzeDatei.npos)
			{
			...
			if ((aktPos1 = ganzeDatei.find(", Area ", aktPos2)) < intfpos)
			{
				aktPos1 += 7;
				aktPos2 = ganzeDatei.find_first_of(", \r\n\t", aktPos1);
				area = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("Process ID ", aktPos2)) < intfpos)
			{
				aktPos1 += 11;
				aktPos2 = ganzeDatei.find(",", aktPos1);
				processID = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find(", Network Type ", aktPos2)) < intfpos)
			{
				aktPos1 += 15;
				aktPos2 = ganzeDatei.find(",", aktPos1);
				nwType = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find(", Cost: ", aktPos2)) < intfpos)
			{
				aktPos1 += 8;
				aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
				cost = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			parserdb->insertOspfIntf(area, nwType, cost, processID, intfName, dev_id);
		}
	}
	// OSPF Neighbor pos14-pos15
	//////////////////////////////////////////////////
	size_t neighborpos = ganzeDatei.find(", interface address ", pos14);
	if (neighborpos < pos15)
	{
		neighborpos = ganzeDatei.rfind("\n", neighborpos);

		while (neighborpos < pos15)
		{
			// Interface Name
			aktPos1 = neighborpos;
			neighborpos = ganzeDatei.find(", interface address ", neighborpos + 70);
			if (neighborpos > pos15)
			{
				neighborpos = pos15 + 2;
			}
			...
			std::string neighborIntfIP = "";
			std::string neighborState = "";
			std::string neighborStateChanges = "";
			std::string neighborAS = "";
			std::string intfName = "";
			std::string uptime = "";

			aktPos1 = ganzeDatei.find("Neighbor ", aktPos1) + 9;
			aktPos2 = ganzeDatei.find(",", aktPos1);
			neighborID = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			if ((aktPos1 = ganzeDatei.find(", interface address ", aktPos2)) < neighborpos)
			{
				aktPos1 += 20;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				neighborIntfIP = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find(" via interface ", aktPos2)) < neighborpos)
			{
				aktPos1 += 15;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				intfName = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			...
			if ((aktPos1 = ganzeDatei.find(", State is ", aktPos2)) < neighborpos)
			{
				aktPos1 += 11;
				aktPos2 = ganzeDatei.find(",", aktPos1);
				neighborState = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

				aktPos1 = aktPos2 + 2;
				aktPos2 = ganzeDatei.find(" state changes", aktPos1);
				neighborStateChanges = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("Neighbor is up for ", aktPos2)) < neighborpos)
			{
				aktPos1 += 19;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				uptime = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
...
void WkmParser::ipsecParser()
{
	zeitStempel("\tipsecParser START");
		aktPos1 = aktPos2 = 0;
	size_t cryptoPosIntf = ganzeDatei.find("interface: ", pos13);
	while (cryptoPosIntf < pos14)
	{
		aktPos1 = cryptoPosIntf + 11;
		aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
		std::string cryptoIntfName = ganzeDatei.substr(aktPos1, aktPos2-aktPos1);
		cryptoIntfName = parserdb->intfNameChange(cryptoIntfName);
		
		aktPos1 = ganzeDatei.find("Crypto map tag", cryptoPosIntf);
		size_t cryptoPosPeer = aktPos1;
		aktPos1 += 14;
		aktPos2 = ganzeDatei.find(",", aktPos1);
		std::string cryptoMapTag = ganzeDatei.substr(aktPos1, aktPos2-aktPos1);
		if (cryptoMapTag[0] == ':')
		{
			cryptoMapTag.erase(0,1);
		}
		boost::algorithm::trim(cryptoMapTag);
		
		aktPos1 = ganzeDatei.find("local addr", aktPos2) + 10;
		aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
		std::string cryptoLocalIP = ganzeDatei.substr(aktPos1, aktPos2-aktPos1);
		if (cryptoLocalIP[0] == ':')
		{
			cryptoLocalIP.erase(0,1);
		}
		boost::algorithm::trim(cryptoLocalIP);

		parserdb->insertCryptoIntf(cryptoMapTag, cryptoLocalIP, "", cryptoIntfName, dev_id);
		
		// Nächstes Crypto Interface finden und wenn ok, dann mit der While Schleife weitermachen 
		cryptoPosIntf = ganzeDatei.find("interface: ", cryptoPosIntf+30);
		if (cryptoPosIntf > pos14)
		{
			cryptoPosIntf = pos14;
		}

		while (cryptoPosPeer < cryptoPosIntf)
		{
			aktPos1 = cryptoPosPeer;
			cryptoPosPeer = ganzeDatei.find("Crypto map tag", cryptoPosPeer + 30);

			WkmParserDB::cryptoSets *cSets = new WkmParserDB::cryptoSets;
			cSets->dev_id = dev_id;
			cSets->intfName = cryptoIntfName;
			cSets->tag = cryptoMapTag;
			...
			if ((aktPos1 = ganzeDatei.find("seq num: ", aktPos1)) < cryptoPosPeer)
			{
				aktPos1 += 9;
				aktPos2 = ganzeDatei.find(", ", aktPos1);
				cSets->seqnr = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			
			aktPos1 = ganzeDatei.find("local ident", aktPos2);
			if ((aktPos1 = ganzeDatei.find("): (", aktPos1)) < cryptoPosPeer)
			{
				aktPos1 += 4;
				aktPos2 = ganzeDatei.find(")", aktPos1);
				cSets->local_net = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			if ((aktPos1 = ganzeDatei.find("remote ident", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 = ganzeDatei.find("): (", aktPos1) + 4;
				aktPos2 = ganzeDatei.find(")", aktPos1);
				cSets->remote_net = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			if ((aktPos1 = ganzeDatei.find("current_peer", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 = ganzeDatei.find_first_not_of(": ", aktPos1+12);
				aktPos2 = ganzeDatei.find_first_of(" \r\n", aktPos1);
				cSets->peer = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			if ((aktPos1 = ganzeDatei.find("#pkts encaps: ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 14;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->pkt_encaps = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("#pkts encrypt: ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 15;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->pkt_encrypt = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("#pkts decaps: ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 14;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->pkt_decaps = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("#pkts decrypt: ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 15;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->pkt_decrypt = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			if ((aktPos1 = ganzeDatei.find("#send errors: ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 14;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->send_err = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("#recv errors: ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 14;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->rcv_err = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			if ((aktPos1 = ganzeDatei.find("path mtu ", aktPos2)) < cryptoPosPeer)
			{
				aktPos1 += 9;
				aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
				cSets->path_mtu = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}

			bool inboundSPI = false;
			bool outboundSPI = false;

			if ((aktPos1 = ganzeDatei.find("inbound esp sas:", aktPos2)) < cryptoPosPeer)
			{
				if ((aktPos1 = ganzeDatei.find("spi: ", aktPos2)) < cryptoPosPeer)
				{
					aktPos1 += 5;
					aktPos2 = ganzeDatei.find_first_of(" \r\n,", aktPos1);
					std::string spi = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
					if (spi.length() > 5)
					{
						inboundSPI = true;
					}

					if ((aktPos1 = ganzeDatei.find("transform: ", aktPos2)) < cryptoPosPeer)
					{
						aktPos1 += 11;
						aktPos2 = ganzeDatei.find_first_of("\r\n,", aktPos1);
						cSets->esp_i = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
					}
				}
			}
			if ((aktPos1 = ganzeDatei.find("outbound esp sas:", aktPos2)) < cryptoPosPeer)
			{
				if ((aktPos1 = ganzeDatei.find("spi: ", aktPos2)) < cryptoPosPeer)
				{
					aktPos1 += 5;
					...
					if ((aktPos1 = ganzeDatei.find("transform: ", aktPos2)) < cryptoPosPeer)
					{
						aktPos1 += 11;
						aktPos2 = ganzeDatei.find_first_of("\r\n,", aktPos1);
						cSets->esp_o = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
					}
				}
			}

			if ((aktPos1 = ganzeDatei.find("inbound ah sas:", aktPos2)) < cryptoPosPeer)
			{
				if ((aktPos1 = ganzeDatei.find("spi: ", aktPos2)) < cryptoPosPeer)
				{
					aktPos1 += 5;
					...
					if ((aktPos1 = ganzeDatei.find("transform: ", aktPos2)) < cryptoPosPeer)
					{
						aktPos1 += 11;
						aktPos2 = ganzeDatei.find_first_of("\r\n,", aktPos1);
						cSets->ah_i = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
					}
				}
			}
			if ((aktPos1 = ganzeDatei.find("outbound ah sas:", aktPos2)) < cryptoPosPeer)
			{
				if ((aktPos1 = ganzeDatei.find("spi: ", aktPos2)) < cryptoPosPeer)
				{
					aktPos1 += 5;
					...
					if ((aktPos1 = ganzeDatei.find("transform: ", aktPos2)) < cryptoPosPeer)
					{
						aktPos1 += 11;
						aktPos2 = ganzeDatei.find_first_of("\r\n,", aktPos1);
						cSets->ah_o = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
					}
				}
			}


			if (inboundSPI && outboundSPI)
			{
				cSets->status = "ACTIVE";
			}
		...
		// Crypto Interfaces einfügen
		parserdb->insertCryptoMapIntf(cryptoIntfName, dev_id);
	}
}


void WkmParser::nxosBGPParser()
{
	zeitStempel("\tnxosBGPParser START");
}


void WkmParser::nxosOSPFParser()
{
	zeitStempel("\tnxosOSPFParser START");

	// show ip ospf
	/////////////////////////////////////////////////////
	if (pos36 - pos35 > 300)
	{
		size_t procpos = ganzeDatei.find("Routing Process ", pos35);
		if (procpos < pos36)
		{
			procpos += 16;
			...
			while (procpos < pos36)
			{
				...
				if ((aktPos1 = ganzeDatei.find("with ID ", aktPos2)) < pos36)
				{
					aktPos1 += 8;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					routerID = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
				}
				if ((aktPos1 = ganzeDatei.find("VRF ", aktPos2)) < pos36)
				{
					aktPos1 += 4;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					vrf = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
				}
				if ((aktPos1 = ganzeDatei.find("SPF calculation has run ", aktPos2)) < pos36)
				{
					aktPos1 += 24;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					spfExecNumber = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
	...
	//////////////////////////////////
	size_t intfpos = ganzeDatei.find(", line protocol is", pos36);
	if (intfpos < pos37)
	{
		intfpos = ganzeDatei.rfind("\n", intfpos);
	...
	// OSPF Neighbor pos11-pos12
	//////////////////////////////////////////////////
	size_t neighborpos = ganzeDatei.find(", interface address ", pos11);
	if (neighborpos < pos12)
	{
		neighborpos = ganzeDatei.rfind("\n", neighborpos);

		while (neighborpos < pos12)
		{
			// Interface Name
			aktPos1 = neighborpos;
			neighborpos = ganzeDatei.find(", interface address ", neighborpos + 70);
			...
			if ((aktPos1 = ganzeDatei.find(", last change ", aktPos2)) < neighborpos)
			{
				aktPos1 += 14;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				uptime = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
...
void WkmParser::nxosEIGRPParser()
{
	zeitStempel("\tnxosEIGRPParser START");
}
...
void WkmParser::iosBGPParser()
{
	...
	if (pos11 - pos10 > 300)
	{
		...
		if ((aktPos1 = ganzeDatei.find(", local AS number ", pos10)) < pos11)
		{
			aktPos1 += 18;
			aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
			localAS = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

			parserdb->insertRpGlobal(localAS, dev_id);
		}
		if ((aktPos1 = ganzeDatei.find("Neighbor", aktPos2)) < pos11)
		{
			aktPos1 = ganzeDatei.find("\n", aktPos1);
			std::string neighborString = ganzeDatei.substr(aktPos1, pos11 - aktPos1);
			std::string nZeile = "";
			aktPos1 = 0;
			...
			while (aktPos2 < neighborString.npos)
			{
				aktPos2 = neighborString.find_first_of("\r\n", aktPos1 + 1);
				nZeile = neighborString.substr(aktPos1 + 1, aktPos2 - aktPos1 - 1);
				aktPos1 = aktPos2;
				if (nZeile.size() > 50)
				{
					int i = 0;
					boost::char_separator<char> sep(" \t");
					boost::tokenizer<boost::char_separator<char>> tok(nZeile, sep);
					...
					// Interface rausfinden: Ab pos39 nach "BGP neighbor is 83.64.142.225" suchen und dann weiter nach "Local host: 83.64.142.226, " 
					// und die gefundene IP Adresse in der Interface Tabelle suchen und den Interface Namen auslesen
					if ((tpos1 = ganzeDatei.find("BGP neighbor is " + neighborIntfIP, pos39)) != ganzeDatei.npos)
					{
						if ((tpos1 = ganzeDatei.find("remote router ID ", tpos1)) != ganzeDatei.npos)
						{
							tpos1 += 17;
							tpos2 = ganzeDatei.find_first_of("\r\n\t ", tpos1);
							neighborID = ganzeDatei.substr(tpos1, tpos2 - tpos1);
						}
						if ((tpos1 = ganzeDatei.find("Local host: ", tpos1)) != ganzeDatei.npos)
						{
							tpos1 += 12;
							tpos2 = ganzeDatei.find(",", tpos1);
							std::string localIP = ganzeDatei.substr(tpos1, tpos2 - tpos1);

							// ParserDB Funktion bauen
							intfName = parserdb->getIntfNamefromIP(localIP, dev_id);
						}
					}
					parserdb->insertRpNeighbor(rp, neighborID, neighborIntfIP, uptime, neighborState, neighborStateChanges, neighborAS, intfName, dev_id);
				
					// Check ob Neighbor State > 300k Routen hat; Dann Default Route auf diesen Hop legen
					int routeCount = 0;
					try
					{
						routeCount = boost::lexical_cast<int>(neighborState);
					}
					catch (boost::bad_lexical_cast &)
					{
						routeCount = 0;
					...
					if (routeCount > 300000)
					{
						parserdb->insertRoute("B", "0.0.0.0", "/0", neighborIntfIP, intfName, "", dev_id);
					}
				}
			}
		}
	...
	if (pos36 - pos35 > 300)
	{
		...
		if (procpos < pos36)
		{
			...
			while (procpos < pos36)
			{
				...
				if ((aktPos1 = ganzeDatei.find("SPF algorithm last executed ", aktPos2)) < pos36)
				{
					aktPos1 += 28;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					spfLast = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
				}
				if ((aktPos1 = ganzeDatei.find("SPF algorithm executed ", aktPos2)) < pos36)
				{
					aktPos1 += 23;
					aktPos2 = ganzeDatei.find_first_of("\r\n \t", aktPos1);
					spfExecNumber = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
...
void WkmParser::iosVrfRouteArpParser()
{
	zeitStempel("\tiosVrfRouteArpParser START");
	std::size_t vrfPos1 = ganzeDatei.find("show ip route vrf ", pos99);
	std::size_t vrfPos2 = ganzeDatei.find("show ip arp vrf ", pos99);
	while (vrfPos1 != ganzeDatei.npos)
	{
		iosRouteParser(vrfPos1, vrfPos2);
		vrfPos1 = ganzeDatei.find("show ip route vrf ", vrfPos2);
		iosARPParser(vrfPos2, vrfPos1);
		vrfPos2 = ganzeDatei.find("show ip arp vrf ", vrfPos1);
	}
}


void WkmParser::iosDot1xParser()
{
	zeitStempel("\tiosDot1xParser START");
	if (pos43 - pos42 > 80)
	{
		aktPos1 = ganzeDatei.find("Sysauthcontrol", pos42);
		std::string dot1xSystemStatus = "UNKNOWN";
		std::string dot1xProtVersion = "UNKNOWN";
		if (aktPos1 < pos43)
		{
			aktPos1 += 23;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			dot1xSystemStatus = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			boost::algorithm::trim(dot1xSystemStatus);

			aktPos1 = ganzeDatei.find("Dot1x Protocol Version", aktPos2);
			aktPos1 += 23;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			dot1xProtVersion = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			boost::algorithm::trim(dot1xProtVersion);

			parserdb->insertDot1xDev(dot1xSystemStatus, dot1xProtVersion, dev_id);
		}
		
		
		
		size_t intfpos = ganzeDatei.find("Dot1x Info for ", pos42);

		while (intfpos < pos43)
		{
			// Interface Name
			aktPos1 = intfpos + 15;
			intfpos = ganzeDatei.find("Dot1x Info for ", intfpos + 30);
			if (intfpos > pos43)
			{
				intfpos = pos43 + 2;
			}
			...
			aktPos1 = ganzeDatei.find("PAE", aktPos2);
			aktPos1 = ganzeDatei.find("=", aktPos1) + 2;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			dot1x = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

			parserdb->insertDot1xIntf(dot1x, "", intfName, dev_id);
		}
	}
	parserdb->iosDot1xUpdater();
}


void WkmParser::iosMabParser()
{
	zeitStempel("\tiosMabParser START");
	if (pos44 - pos43 > 300)
	{
		size_t intfpos = ganzeDatei.find("MAB details for ", pos43);

		while (intfpos < pos44)
		{
			// Interface Name
			aktPos1 = intfpos + 16;
			intfpos = ganzeDatei.find("MAB details for ", intfpos + 30);
			if (intfpos > pos44)
			{
				intfpos = pos44 + 2;
			}
			...
			aktPos1 = ganzeDatei.find("Mac-Auth-Bypass", aktPos2);
			aktPos1 = ganzeDatei.find("=", aktPos1) + 2;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			mab = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

			parserdb->insertDot1xIntf("", mab, intfName, dev_id);
		}
	}
	parserdb->iosMabUpdater();
}


void WkmParser::iosAuthParser()
{
	zeitStempel("\tiosAuthParser START");
	
	if ((aktPos1 = ganzeDatei.find("Session ID", pos44)) < pos45)
	{
		bool neueVer = false;	// Mit 15.2.2 wurde die Ausgabe verändert; true wenn neue Version
		std::size_t tempPos = 0;
		if ((tempPos = ganzeDatei.find("Session count = ", aktPos1)) < pos45)
		{
			neueVer = true;
		}
		else
		...
		std::string authz = ganzeDatei.substr(aktPos1, tempPos-aktPos1);
		std::string authzZeile = "";
		...
		for (; aktPos2 < authz.npos;)
		{
			aktPos2 = authz.find("\n", aktPos1+1);
			authzZeile = authz.substr(aktPos1, aktPos2 - aktPos1);
			aktPos1 = aktPos2;
			if (authzZeile.size() > 50)
			{
				int i = 0;
				boost::tokenizer<boost::offset_separator> tok(authzZeile, f1);
				for (boost::tokenizer<boost::offset_separator>::iterator beg = tok.begin(); beg != tok.end(); ++beg)
				{
					switch (i)
					{
					...
					case 5:
						sessionID = *beg;
						boost::algorithm::trim(sessionID);
						break;
					default:
						break;
					}
				...
				parserdb->insertDot1xUser(macAddress, method, domain, status, intfName, dev_id);
			}
		}
	}
}
...
void WkmParser::iosVlanParser()
{
	zeitStempel("\tiosVlanParser START");

	if ((aktPos1 = ganzeDatei.find("---- -----", pos45)) < pos46)
	{
		aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1);
		std::string vlans = ganzeDatei.substr(aktPos1, pos46 - aktPos1);
		std::string vlanZeile = "";
		...
		aktPos1 = aktPos2 = 0;
		boost::offset_separator f1(off, off + 3, false);
		for (; aktPos2 < vlans.npos;)
		{
			aktPos2 = vlans.find("\n", aktPos1 + 1);
			vlanZeile = vlans.substr(aktPos1, aktPos2 - aktPos1);
			aktPos1 = aktPos2;
			if ((vlanZeile.size() > 50) && (vlanZeile[0] != ' '))
			{
				int i = 0;
				boost::tokenizer<boost::offset_separator> tok(vlanZeile, f1);
				for (boost::tokenizer<boost::offset_separator>::iterator beg = tok.begin(); beg != tok.end(); ++beg)
				{
					switch (i)
					{
					case 0:
						vlanID = *beg;
						boost::algorithm::trim(vlanID);
						break;
					case 1:
						vlanName = *beg;
						boost::algorithm::trim(vlanName);
						break;
					default:
						break;
					}
...
void WkmParser::iosDhcpSnoopParser()
{
	zeitStempel("\tiosDhcpSnoopParser START");
	
	if ((aktPos1 = ganzeDatei.find("Switch DHCP snooping is ", pos47)) < pos48)
	{
		aktPos1 = aktPos1 + 24;
		aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
		std::string dhcpSnoopState = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		std::string dhcpSnoopVlans = "";
		std::string dhcpSnoop82 = "";

		if ((aktPos1 = ganzeDatei.find("DHCP snooping is configured on following VLANs:", aktPos2)) < pos48)
		{
			aktPos1 += 48;
			aktPos1 = ganzeDatei.find_first_not_of("\r\n: \t", aktPos1);
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			dhcpSnoopVlans = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		}

		if ((aktPos1 = ganzeDatei.find("Insertion of option 82 is ", aktPos2)) < pos48)
		{
			aktPos1 += 26;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			dhcpSnoop82 = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		}

		parserdb->insertSnoopingDev(dhcpSnoopState, dhcpSnoopVlans, dhcpSnoop82, dev_id);

		if ((aktPos1 = ganzeDatei.find("-----------------------", aktPos2)) < pos48)
		{
			// Aktive Interfaces auslesen
			aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1);
			std::string table = ganzeDatei.substr(aktPos1, pos48 - aktPos1);
			...
			aktPos1 = aktPos2 = 0;
			boost::offset_separator f1(off, off + 3, false);
			for (; aktPos2 < table.npos;)
			{
				aktPos2 = table.find("\n", aktPos1 + 1);
				tableEntry = table.substr(aktPos1, aktPos2 - aktPos1);
				aktPos1 = aktPos2;
				if ((tableEntry.size() > 50) && tableEntry[0] != ' ')
				{
					int i = 0;
					boost::tokenizer<boost::offset_separator> tok(tableEntry, f1);
					for (boost::tokenizer<boost::offset_separator>::iterator beg = tok.begin(); beg != tok.end(); ++beg)
					{
						switch (i)
						{
						...
						case 1:
							trustState = *beg;
							boost::algorithm::trim(trustState);
							break;
						default:
							break;
						}
					...
					parserdb->insertSnoopingIntf(trustState, intfName, dev_id);
				}
			}
		}
	}
...
void WkmParser::iosDhcpSnoopBindParser()
{
	zeitStempel("\tiosDhcpSnoopBindParser START");


	if ((aktPos1 = ganzeDatei.find("------  ------", pos48)) < pos49)
	{
		aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1);
		std::string table = ganzeDatei.substr(aktPos1, pos49 - aktPos1);
		std::string tableEntry = "";
		...
		bool alteVer = false;		// Alte Catalyst Versionen haben unterschiedliche Spaltenbreiten
		if (ganzeDatei.find("Total number of bindings:", aktPos1) > pos49)
		{
			alteVer = true;
		}

		int off[] = { 20, 17, 12, 15, 6, 25 };
		if (alteVer)
		{
			off[3] = 9;
		}
		...
		for (; aktPos2 < table.npos;)
		{
			...
			if (tableEntry.size() > 50)
			{
				...
				for (boost::tokenizer<boost::offset_separator>::iterator beg = tok.begin(); beg != tok.end(); ++beg)
				{
					...
					case 2:
						leaseTime = *beg;
						boost::algorithm::trim(leaseTime);
						break;
					case 4:
						vlanID = *beg;
						boost::algorithm::trim(vlanID);
...
void WkmParser::iosDevTrackingParser()
{
	zeitStempel("\tiosDevTrackingParser START");

	if ((aktPos1 = ganzeDatei.find("IP Device Tracking", pos49)) < ganzeDatei.npos)
	{
		bool neueVer = false;
		if (ganzeDatei.find("Global IP Device Tracking ", aktPos1) != ganzeDatei.npos)
		{
			neueVer = true;
		}
		
		// Zuerst globale Einstellungen:
		std::string devTrackStatus = "";
		std::string devTrackProbeCount = "";
		std::string devTrackProbeInterval = "";
		std::string devTrackProbeDelayInterval = "";

		aktPos1 = ganzeDatei. find("= ", aktPos1) + 2;
		aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
		devTrackStatus = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);

		if (devTrackStatus.find("nable") != devTrackStatus.npos)
		{
			if ((aktPos1 = ganzeDatei.find("IP Device Tracking Probe Count = ", pos49)) < ganzeDatei.npos)
			{
				aktPos1 += 33;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				devTrackProbeCount = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("IP Device Tracking Probe Interval = ", pos49)) < ganzeDatei.npos)
			{
				aktPos1 += 36;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				devTrackProbeInterval = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			if ((aktPos1 = ganzeDatei.find("IP Device Tracking Probe Delay Interval = ", pos49)) < ganzeDatei.npos)
			{
				aktPos1 += 42;
				aktPos2 = ganzeDatei.find_first_of("\r\n\t ", aktPos1);
				devTrackProbeDelayInterval = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
			}
			// Zur Device Tabelle hinzufügen
			parserdb->insertDevTrackingDev(devTrackStatus, devTrackProbeCount, devTrackProbeInterval, devTrackProbeDelayInterval, dev_id);

			if (devTrackStatus != "")
			{
				aktPos1 = ganzeDatei.find("MAC Address", pos49);
				aktPos1 = ganzeDatei.find("-----------", aktPos1);
				aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1);
				if (aktPos1 != ganzeDatei.npos)
				{
					aktPos2 = ganzeDatei.find("Total number interfaces enabled", pos49);
					std::string table = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
					std::string tableEntry = "";
					...
					aktPos1 = aktPos2 = 0;
					boost::offset_separator f1(off, off + 5, false);
					for (; aktPos2 < table.npos;)
					{
						aktPos2 = table.find("\n", aktPos1 + 1);
						tableEntry = table.substr(aktPos1, aktPos2 - aktPos1);
						...
						if (tableEntry.size() > 50)
						{
							...
							for (boost::tokenizer<boost::offset_separator>::iterator beg = tok.begin(); beg != tok.end(); ++beg)
							{
								...
								case 3:
									intfName = *beg;
									boost::algorithm::trim(intfName);
									// In der neuen Verison werden Spalten Interface und Probe-Timeout zusammengefasst. Daher wird Probe-Timeout weggefiltert.
									intfName = intfName.substr(0, intfName.find(" "));
									intfName = parserdb->intfNameChange(intfName);
									break;
								case 4:
									state = *beg;
...
void WkmParser::iosMSTParser()
{
	zeitStempel("\tiosMSTParser START");

}


void WkmParser::iosRouteParser(std::size_t startpos, std::size_t endePos)
{
	zeitStempel("\tiosRouteParser START");
	size_t routePos = ganzeDatei.find("Gateway of last resort", startpos);
	aktPos1 = ganzeDatei.find_first_of("\r\n", routePos);

	if (routePos > endePos)
	{
		routePos = ganzeDatei.find("via", startpos);
		aktPos1 = routePos-45;
	}
	
	if (routePos < endePos)
	{
		std::string routes = ganzeDatei.substr(aktPos1, endePos - aktPos1);
		//aktPos1 = routes.find("\r\n ");
		//while (aktPos1 < routes.npos)
		//{
		//	routes.erase(aktPos1, 4);
		...
		while (aktPos2 != routes.npos)
		{
			...
			if (rZeile[0] != ' ')
			{
				rp = rZeile.substr(0, 6);
				boost::algorithm::trim(rp);
				rZeile = rZeile.substr(6, rZeile.npos);
			}
	...
	else if ((aktPos1 = ganzeDatei.find("Default gateway is ", startpos)) < endePos)
	{
		aktPos1 += 19;
		aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
		std::string defGW = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		parserdb->insertRoute("S", "0.0.0.0", "/0", defGW, "", "", dev_id);
	}
...
void WkmParser::iosSwitchportParser()
{
	...
	while (intfpos < ganzeDatei.npos)
	{
		...
		if ((opModePos > intfpos) || (opModePos > pos21))
		...
		// Check, ob suspended Channel Member
		if ((aktPos1 = l2Mode.find("suspended member of bundle ")) != l2Mode.npos)
		{
			aktPos1 += 27;
			aktPos2 = l2Mode.find(")");
			std::string chIntf = l2Mode.substr(aktPos1, aktPos2 - aktPos1);
			chIntf = parserdb->intfNameChange(chIntf);
			std::string chIntfId = parserdb->getIntfID(dev_id, chIntf);

			// Channel Zugehörigkeit markieren
			parserdb->updateChannelMember(chIntfId, intfName, dev_id);
		}
	}
}


void WkmParser::nxosSwitchportParser()
{
	zeitStempel("\tnxosSwitchportParser START");
	...
	while (intfpos < ganzeDatei.npos)
	{
		...
		if ((aktPos1 = ganzeDatei.find("Trunking VLANs Allowed: ", aktPos2)) < intfpos)
		{
			aktPos1 += 24;
			aktPos2 = ganzeDatei.find_first_of("\r\n ", aktPos1);
			allowedVlan = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		...
		if ((aktPos1 = ganzeDatei.find("Operational private-vlan: ", aktPos2)) < intfpos)
		{
			aktPos1 += 26;
			aktPos2 = ganzeDatei.find_first_of("\r\n ", aktPos1);
			opPrivVlan = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
...
void WkmParser::testPhones()
{
	...
	if (htmlPos != ganzeDatei.npos)
	{
		...
		bool ata = false;	// ATA 187 -> Ja/Nein?
		if (aktPos1 != ganzeDatei.npos)
		{
			aktPos1 = htmlParse.find_first_of("<>;&\r\n\t", aktPos1);
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos1);
		...
		if (ata)
		{
			// Telefonnummer#2 -> Wird als snmpLoc abgespeichert
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos2);
			aktPos1 = htmlParse.find_first_of("<>;&", aktPos1);
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos1);
			aktPos2 = htmlParse.find_first_of("<>;&\r\n\t", aktPos1);
			...
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos1);
			aktPos2 = htmlParse.find_first_of("<>;&\r\n\t", aktPos1);
			std::string tempStandort = htmlParse.substr(aktPos1, aktPos2-aktPos1);

			try
			{
				int temp = boost::lexical_cast<int>(tempStandort);
			}
			catch (boost::bad_lexical_cast &)
			{
				tempStandort = "UNKNOWN";			
			}

			standort = "Line 1: " + standort + " // Line 2: " + tempStandort;
		...
		// HW Revision
		aktPos1 = htmlParse.find("ev", aktPos2);
		if (aktPos1 != htmlParse.npos)
		{
			aktPos1 = htmlParse.find_first_of("<>;&", aktPos1);
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos1);
		...
		if (aktPos1 != htmlParse.npos)
		{
			...
			tempPos = htmlParse.find("ATA", aktPos2);
			if (aktPos1 != htmlParse.npos)
			{
				aktPos2 = htmlParse.find_first_of("<>;&\r\n\t ", aktPos1);
				modell = htmlParse.substr(aktPos1, aktPos2-aktPos1);
			}
			else if (tempPos != htmlParse.npos)
			{
				aktPos2 = htmlParse.find_first_of("<>;&\r\n\t ", tempPos);
				modell = htmlParse.substr(tempPos, aktPos2-tempPos);
			}
			else
			{
				aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos2);
		...
		std::string cdpPlatform = "";
		if (ata && (aktPos1 = htmlParse.find("Device ID", aktPos2)) != htmlParse.npos)
		{
			if ((aktPos1 = htmlParse.find("Voice VLAN", aktPos1)) != htmlParse.npos)
			{
				aktPos1 = htmlParse.find_first_of("<>;&\r\n\t", aktPos1);
				aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos1);
				aktPos2 = htmlParse.find_first_of("<>;&\r\n\t ", aktPos1);
		...
		else if ((aktPos1 = htmlParse.find("CDP", aktPos2)) != htmlParse.npos)
		{
			aktPos1 = htmlParse.find_first_of("<>;&\r\n\t", aktPos1);
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t", aktPos1);
			aktPos2 = htmlParse.find_first_of("<>;&\r\n\t ", aktPos1);
		...
		if (ata)
		{
			...
			aktPos1 = htmlParse.find_first_not_of("<>;&\r\n\t ", aktPos1);
			aktPos2 = htmlParse.find_first_of("<>;&\r\n\t", aktPos1);
			cdpPlatform = htmlParse.substr(aktPos1, aktPos2-aktPos1);
		...
		else if (cdpNeigh.find("-IP-") != cdpNeigh.npos)
		{
			cdpNeigh = "";
		}
		else
		...
		// INTERFACE
		//////////////////////////////////////////////////////////////////////////
		intf_id = parserdb->insertInterface("Port 1", "", intfType, "1", macAdresse, ipa, subnetMask, duplex, speed, "UP", "Uplink Port", "L2", dev_id);
		...
		if (cdpNeigh != "")
		{
			...
			// DB befüllen
			parserdb->insertCDP(hostname, nName, alternatenName, "Port 1", cdpNeighIP, cdpNeighPort, "2", cdpPlatform, "", dev_id);

		}

		// Endgeräte INTERFACE -> Generisches Interface zum Anzeigen, ob Endgeräte angeschlossen ist
		//////////////////////////////////////////////////////////////////////////
		intf_id = parserdb->insertInterface("Port 2", "", "", "1", "", "", "", "", "", "UP", "PC Port", "L2", dev_id);
	}
	else
	{
...
void WkmParser::pixOSLicParser()
{
	...
	if (aktPos1 < pos2)
	{
		...
		std::string licZeile = "";
		size_t dppos = licString.find_first_not_of("\r\n");
		dppos = licString.find(":", dppos)-1;
		int offsets[] = {dppos, 2, 15, 30};
		boost::offset_separator f(offsets, offsets+4, false);
		aktPos1 = aktPos2 = 0;
		for (; aktPos2 < licString.npos;)
		{
			...
			if (licZeile.size() > 35)
			{
				...
				for(boost::tokenizer<boost::offset_separator>::iterator beg=tok.begin(); beg!=tok.end();++beg)
				{
					...
					case 0:			// Name
						licName = *beg;
						boost::algorithm::trim(licName);
						break;
					case 1:			// Nix
						break;
					case 2:			// Anzahl/Art
						licStatus = *beg;
						boost::algorithm::trim(licStatus);
						break;
					case 3:			// Info
						licType = *beg;
						boost::algorithm::trim(licType);
						break;
					default:
						break;
					}
		...
		if (poePos1 != ganzeDatei.npos)
		{
			...
			else
			{
					...
					else
					{
						...
						if (tpos2 < pos29)
						{
							...
							while (aktPos2 != boxPoe.npos)
							{
								...
								aktPos1 = aktPos2;
								bool schreibeInfo = false;
								if ((poeZeile.size() > 25) && (poeZeile.find("Interface") == poeZeile.npos) && (poeZeile.find("-----") == poeZeile.npos))
								{
									int i = 0;
									boost::char_separator<char> sep(" \t\r\n");
				...
				for (; aktPos2 < poeString.npos;)
				{
					...
					aktPos1 = aktPos2;
					bool schreibeInfo = false;
					if ((poeZeile.size() > 45) && (poeZeile.find("Interface") == poeZeile.npos) && (poeZeile.find("-----") == poeZeile.npos) && (poeZeile.find("(Watts)") == poeZeile.npos))
					{
						int i = 0;
						boost::tokenizer<boost::offset_separator> tok(poeZeile, f);
						for(boost::tokenizer<boost::offset_separator>::iterator beg=tok.begin(); beg!=tok.end();++beg)
...
void WkmParser::iosVrfParser()
{
	...
	aktPos1 = aktPos2 = 0;
	size_t vrfPos = ganzeDatei.find("VPNID", pos31);
	while (vrfPos < pos32)
	{
		vrfPos = ganzeDatei.rfind("\n", vrfPos);
		size_t vrfIntfStart = ganzeDatei.find("Interfaces:", vrfPos);
		size_t vrfIntfStart1 = ganzeDatei.find("No interfaces", vrfPos);
		if (vrfIntfStart1 < vrfIntfStart)
		{
			// Keine Interfaces -> Überspringen
			// Nächstes VRF finden und wenn ok, dann mit der While Schleife weitermachen 
			vrfPos = ganzeDatei.find("VPNID", vrfIntfStart1);
			continue;
		}
		size_t vrfIntfEnde = ganzeDatei.find("Connected addresses = ", vrfIntfStart);
		if (vrfIntfEnde > pos32)
		{
			vrfIntfEnde = ganzeDatei.find("Address family", vrfIntfStart);
			if (vrfIntfEnde > pos32)
			{
				vrfIntfEnde = ganzeDatei.find("Table ID = ", vrfIntfStart);
			}
		}
		...
		aktPos2 = ganzeDatei.find_first_of("(;", vrfPos);
		aktPos1 = vrfPos + 5;
		vrfName = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
		boost::algorithm::trim(vrfName);
		...
		// Nächstes VRF finden und wenn ok, dann mit der While Schleife weitermachen 
		vrfPos = ganzeDatei.find("VPNID", vrfIntfEnde);
	}
}
	...
	if (vrfPos < pos31)
	{
		...
		for (; aktPos2 < vrfs.npos;)
		{
			...
			if (vrfZeile.size() > 50)
			{
				...
				if (intName != "Null0")		// Uninteressante und generische Interfaces ausblenden
				{
	...
	while (!rEnde)
	{
		...
		while (viaPos != routes.npos)
		{
			if (viaPos < rPos)
			{
				...
				intf = parserdb->intfNameChange(intf);
				std::string iid = parserdb->getIntfID(dev_id, intf, false);
				if (iid == "" && nh != "Null0")
				{
					// Interface anhand des NextHops rausfinden
					intf = parserdb->nextHopIntfCheck(nh, dev_id);
					intf = parserdb->getIntfNameFromID(intf, false);
				}
...
void WkmParser::nxosFEXParser()
{
}


void WkmParser::nxosHSRPParser()
{
	zeitStempel("\tnxosHSRPParser START");
	iosHSRPParser(pos41, pos42);
}


void WkmParser::iosHSRPParser(std::size_t startPos, std::size_t endPos)
{
	zeitStempel("\tiosHSRPParser START");
	
	aktPos1 = ganzeDatei.find("Interface", startPos);
	aktPos1 = ganzeDatei.find_first_of("\r\n", aktPos1);
	if (aktPos1 < endPos)
	{
		std::string hsrpString = ganzeDatei.substr(aktPos1, endPos-aktPos1);

		std::string hsrpZeile = "";
		...
		for (; aktPos2 < hsrpString.npos;)
		{
			aktPos2 = hsrpString.find_first_of("\r\n", aktPos1+1);
			hsrpZeile = hsrpString.substr(aktPos1, aktPos2 - aktPos1);
			aktPos1 = aktPos2;
			if (hsrpZeile.size() > 50)
			{
				boost::algorithm::trim(hsrpZeile);

				int i = 0;
				boost::char_separator<char> sep(" \t");
				boost::tokenizer<boost::char_separator<char>> tok(hsrpZeile, sep);
				for (boost::tokenizer<boost::char_separator<char>>::iterator beg=tok.begin(); beg!=tok.end(); ++beg)
				{
					switch (i)
					{
				...
				parserdb->insertHSRP(intf, grp, prio, state, active, standby, virtualIP, dev_id);
			}
		}
	}
}
...
void WkmParser::pixOSFailoverParser()
{
	zeitStempel("\tpixOSFailoverParser START");
	// show failover
	//////////////////////////////////////////////////////////////////////////

	if (pos34 - pos33 > 300)
	{
		if ((aktPos1 = ganzeDatei.find("This host: ", pos33)) < pos34)
		{
			aktPos1 += 11;
			aktPos2 = ganzeDatei.find_first_of("\r\n", aktPos1);
			std::string foStatus = ganzeDatei.substr(aktPos1, aktPos2 - aktPos1);
